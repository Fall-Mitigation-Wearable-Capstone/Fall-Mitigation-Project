#include <SparkFunMPU9250-DMP.h>  //library for polling sensor data
#include <MadgwickAHRS.h>         //library for Madgwick filter implementation
...
BluetoothSerial SerialBT; //Setting Bluetooth port

MPU9250_DMP imu; //instance of MPU sensor class
Madgwick filter; //instance of Madgwick filter class
...
void setup() {
  ...
  imu.setSampleRate(FREQ); // Set sample rate to 10Hz
